 ...
 * @author lotushint
 * @version 1.0
 * @date 2022 2022/6/2 12:23
 * @package com.lotushint
 * @description
 */
public class KnapsackBranchBoundary {
    public static void main(String[] args) {
        Knapsack3[] bags = new Knapsack3[]{new Knapsack3(2, 13),
                new Knapsack3(1, 10), new Knapsack3(3, 24), new Knapsack3(2, 15),
                new Knapsack3(4, 28), new Knapsack3(5, 33), new Knapsack3(3, 20),
                new Knapsack3(1, 8)};
        int totalWeight = 12;
...
class Knapsack3 implements Comparable<Knapsack3> {
    /**
     * 物品重量
     */
    private int weight;
    ...
    public Knapsack3(int weight, int value) {
        this.weight = weight;
        this.value = value;
    ...
    @Override
    public int compareTo(Knapsack3 snapsack) {
...
class FZXJProblem {
    ...
    public FZXJProblem(Knapsack3[] bags, int totalWeight) {
        super();
        this.bags = bags;
